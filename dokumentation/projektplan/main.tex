...
En översikt av medlemmarna i arbetsgruppen samt uppdelningen av ansvarsområden och arbetsuppgifter.

\subsection{Gruppmedlemmar och ansvarsområden}

Ansvarsområden samt e-postadresser till alla gruppmedlemmar. Ansvar syftar på att den ansvarige ska se till att arbetet blir gjort, men inte att den ansvarige är skyldig att göra allt.
...
\subsection{Arbetsfördelning} \label{section:arbetsfördelning}

Arbetet kommer delas upp i tre block med två gruppmedlemmar per block. Samarbete mellan grupperna kommer behövas då vissa block säkerligen kräver mer arbete än andra.
...
\begin{table}[H]
    \centering
        \begin{tabular}{ |c|c|c| }\hline
            ...
            3 & Kommunikationsprotokoll klart & 25/09-20 \\\hline
...
Programmeringsarbetet har delats in i tre delar, vilket nämns ovan i sektion \ref{section:arbetsfördelning}. Indelningen är dock flexibel då samarbete mellan grupper kommer behövas. I det fall att ett delmål blir klart före planering kommer medlemmarna att gå vidare till nästa delmål eller bidra i andra arbetsgrupper.
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{ |c|c|c| }\hline
            ...
            16 & Utveckling av extrafunktionalitet & 20h \\\hline
            17 & Tester och testrapport & 100h\\\hline
            18 & Granskning av kod & 50h \\\hline
            19 & Teknisk dokumentation & 50h \\\hline
            20 & Förbered/genomför demonstration & 35h \\\hline
        \end{tabular}
...
\begin{description}
    ...
    \item[Aktivitet 13-20] berör den praktiska delen av projektet. Detta innefattar programmering, test och demonstrationer. (395h)

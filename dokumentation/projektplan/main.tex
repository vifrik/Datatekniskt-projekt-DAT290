...
%den kan simulera MD407-korten med hjälp av programvaran SimServer. Detta är fördelaktigt eftersom gruppmedlemmarna redan har erfarenthet med denna IDE. GitHub används för versionshantering.
...
%Kommunikationen för arbete på distans är via Discord, som stödjer både röst- och textbaserad kommunikation samt skärm- och videodelning.
...
\item [Sista veckorna av projektet] förväntas gruppen arbeta med oppositionsrapport, rapportutkast 2, slutrapport. Utöver detta skall varje gruppmedlem skriva en kamratuppskattning. 

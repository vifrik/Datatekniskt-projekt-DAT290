...
Programmeringsarbetet har delats in i tre delar, vilket nämns ovan i sektion \ref{section:arbetsfördelning}. Indelningen är dock flexibel då sammarbete mellan grupperna kommer behövas. I det fall att ett delmål blir klart före planering kommer medlemmarna att gå vidare till nästa delmål eller bidra i andra arbetsgrupper.

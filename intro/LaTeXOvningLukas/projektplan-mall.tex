...
avsnitt \ref{Resursplan}. I och med att detta sista avsnitt skiljer sig
...
\hline
\hline
 1 & Projectplan inlämnad & 2018-09-16\\ 
\hline
\hline
 ... & ... & ...\\ 
\hline
...
milstolparna kan presenteras ges i tabell \ref{Milstolparprojekt}.
...
raderna i en aktivitetslista ges i tabell\ref{Aktivitetslista}.
...
\begin{figure}
    \centering
     \includegraphics[width=\textwidth]{tidsplan.png}
...
\end{tabular}
\caption{Aktivitetslista för projektet}
\label{Kommunikationsplan för projektet}
\end{table}
...
\item[Analys] Vad innebär testets resultat? Behövs fler test av komponenten?
